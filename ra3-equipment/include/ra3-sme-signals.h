...
enum
{
    ...
    SME_IS_STEP,                ///< Сигнал работы выдвижной ступени
    SME_DOOR_L_OPEN,            ///< Сигнал открыть левые двери
    SME_DOOR_R_OPEN,            ///< Сигнал открыть правые двери
    SME_BUCIK_DESTINATION,      ///< Сигнал с номером станции, выбранной в БУЦИК конечной
