...
void RA3HeadMotor::stepBrakesEquipment(double t, double dt)
{
    ...
    brake_module->setBCpressure(bc_split->getInputPressure());
    ...
    brake_mech[TROLLEY_FWD]->setBCflow(bc_split->getPipeFlow1());
    ...
    brake_mech[TROLLEY_BWD]->setBCflow(bc_split->getPipeFlow2());
